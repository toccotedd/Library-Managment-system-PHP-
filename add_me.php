  ...
  if(isset($_SESSION['username'])){
    ...
    if(isset($_POST['submit'])){ 
       $error=""; 	   
			...
			$age=$_POST['age'];
			$sex=$_POST['sex'];
			if($s_id && $s_name  && $username && $password && $department && $address && $age && $sex){
			   $sql="insert into member values('".$s_id."','".$s_name."','".$username."','".$password."','".$department."','".$address."','".$age."','".$sex."')";
		...
		<div class="post">
			...
			<p class="date">01.23.09</p>
				<div id="contact_form_n">
                	    ...
                	    <form method="post" name="contact" action="add_me.php">
                        <i><center><font color="red"size="2px"><?php if(isset($_POST['submit'])) echo "".$error.""; ?></font></center></i>
                         <label for="author">Member Id:</label> <input type="text" id="author" name="id" class="required input_field" />
                        ...
                        <div class="cleaner_h10"></div>
                         ...
                         <label for="email">Department:</label> <input type="text" id="email" name="department" class="validate-email required input_field" />
                        <div class="cleaner_h10"></div>
